        ...
        <burger-nav>
            ...
            <div id="nav-menu" class="nav-menu">
                <ul class="menu">
                    ...
                    <li><a href="#" data-theme-toggle1><i id="sun1" class="fa-regular fa-sun light-theme"></i><i
                                id="moon1" class="fa-regular fa-moon dark-theme"></i>Theme</a></li>
                </ul>
            </div>
            ...
            <div class="about">
                <div class="about-content">
                    <div class="about-text">
                        ...
                        Welcome to SBEX, crafted by eight passionate developers, a reliable destination for trading and
                        purchasing consumer electronics. Our platform prioritizes safety, offering a seamless experience
                        whether upgrading or selling devices. Verified sellers and stringent security ensure trustworthy
                        transactions. Explore our diverse range, from smartphones to gaming consoles, with confidence in
                        SBEX's commitment to reliability. Join our community built on trust and innovation, where tech
                        enthusiasts find a secure, hassle-free trade-in experience.
                        </p>
                    </div>
